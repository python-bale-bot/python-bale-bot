...
if TYPE_CHECKING:
    from balebot import Bot, User, Chat, Components, Audio, ContactMessage, Location
    
class Message():
    __slots__ = (
        "text", "caption", "forward_from", "_author","contact", "chat","message_id", "date_code", "date", "author", "edit_date", "audio", "document", "photo", "voice", "location", "invoice"
    )
