...
from bale.utils.types import FileInput, AttachmentType, MediaInput, MissingValue, MaybeMissing
...
class Message(BaleObject):
    ...
    ----------
        ...
        forward_from_message_id: :class:`int`, optional
            For forwarded messages, Unique original message identifier. (for channels messages)
        forward_date: :class:`datetime`, optional
            For forwarded messages, time when the original message was sent.
    ...
    def __init__(self, message_id: int, date: datetime, chat: Optional["Chat"] = None,
                 from_user: Optional["User"] = None, forward_from: Optional["User"] = None,
                 forward_from_chat: Optional["Chat"] = None,
                 forward_from_message_id: Optional[int] = None,
                 forward_date: Optional["datetime"] = None,
                 reply_to_message: Optional["Message"] = None,
                 edit_date: Optional["datetime"] = None, text: Optional["str"] = None,
                 animation: Optional["Animation"] = None, audio: Optional["Audio"] = None,
                 document: Optional["Document"] = None,
                 photo: Optional[List["PhotoSize"]] = None,
                 sticker: Optional["Sticker"] = None,
                 video: Optional["Video"] = None, voice: Optional["Voice"] = None,
                 caption: Optional[str] = None, contact: Optional["Contact"] = None,
    ...
    @property
    def attachment(self) -> Optional[AttachmentType, List[PhotoSize]]:
        """:class:`bale.Video` | List[:class:`bale.PhotoSize`] | :class:`bale.Document` | :class:`bale.Animation`,
        optional: Represents the message attachment. ``None`` if the message don't have any attachments"""
        attachment = self.video or self.photo or self.audio or self.animation or self.voice or self.document
        if not attachment:
            return None
    ...
    @property
    def reply_to_message_id(self) -> Optional[int, None]:
        """:obj:`str`, optional: Represents the Unique identifier of Original message, if the message has been replied.
        ``None`` If the message is not replied"""
    ...
    def from_dict(cls, data: Optional[Dict], bot) -> Optional["Message"]:
        ...
        data["forward_date"] = parse_time(data.get('forward_date'))
        data["edit_date"] = parse_time(data.pop('edit_date', None))
        data["photo"] = PhotoSize.from_list(data.pop("photo", None), bot)
        ...
        data["new_chat_members"] = [User.from_dict(new_chat_member_payload, bot) for new_chat_member_payload in
                                    data.get('new_chat_members', [])] or None
    ...
    async def reply_document(self, document: Union["Document", FileInput], *,
                             caption: MaybeMissing[str] = MissingValue,
                             components: MaybeMissing["InlineKeyboardMarkup", "MenuKeyboardMarkup"] = MissingValue,
    ...
    async def reply_photo(self, photo: Union["PhotoSize", FileInput], *, caption: MaybeMissing[str] = MissingValue,
                          components: MaybeMissing["InlineKeyboardMarkup", "MenuKeyboardMarkup"] = MissingValue,
                          delete_after: Optional[Union[float, int]] = None, file_name: Optional[str] = None):
        """
        Shortcut method for:
    ...
    async def reply_sticker(self, sticker: Union["Sticker", FileInput], *,
                            delete_after: Optional[Union[float, int]] = None):
        """
        Shortcut method for:
    ...
    async def reply_video(self, video: Union["Video", InputFile], *, caption: MaybeMissing[str] = MissingValue,
                          components: MaybeMissing["InlineKeyboardMarkup", "MenuKeyboardMarkup"] = MissingValue,
                          delete_after: Optional[Union[float, int]] = None, file_name: Optional[str] = None):
        """
        Shortcut method for:
    ...
    async def reply_animation(self, animation: Union["Animation", FileInput], *,
                              duration: MaybeMissing[int] = MissingValue,
                              width: MaybeMissing[int] = MissingValue, height: MaybeMissing[int] = MissingValue,
                              caption: MaybeMissing[str] = MissingValue,
                              components: MaybeMissing["InlineKeyboardMarkup", "MenuKeyboardMarkup"] = MissingValue,
                              delete_after: Optional[Union[float, int]] = None, file_name: Optional[str] = None):
        """
    ...
    async def reply_audio(self, audio: Union["Audio", InputFile], *, caption: MaybeMissing[str] = MissingValue,
                          components: MaybeMissing["InlineKeyboardMarkup", "MenuKeyboardMarkup"] = MissingValue,
                          delete_after: Optional[Union[float, int]] = None, file_name: Optional[str] = None):
        """
        Shortcut method for:
    ...
    async def reply_location(self, location: "Location", *,
                             components: MaybeMissing["InlineKeyboardMarkup", "MenuKeyboardMarkup"] = MissingValue,
                             delete_after: Optional[Union[float, int]] = None):
        """
        Shortcut method for:
    ...
    async def reply_contact(self, contact: "Contact", *,
                            components: MaybeMissing["InlineKeyboardMarkup", "MenuKeyboardMarkup"] = MissingValue,
                            delete_after: Optional[Union[float, int]] = None):
        """
        Shortcut method for:
    ...
    async def copy(self, chat_id: Union[int, str], reply_to_message_id: MaybeMissing[str, int] = MissingValue,
                   delete_after: Optional[Union[float, int]] = None):
        """
        Shortcut method for:
        ...
        """
        return await self.get_bot().copy_message(chat_id, self.chat_id, self.id,
                                                 reply_to_message_id=reply_to_message_id, delete_after=delete_after)

    async def edit(self, text: str, *,
                   components: MaybeMissing["InlineKeyboardMarkup", "MenuKeyboardMarkup"] = MissingValue) -> Message:
        """
        Shortcut method for:
    ...
    async def edit_caption(self, caption: str, *, components: MaybeMissing[
        "InlineKeyboardMarkup", "MenuKeyboardMarkup"] = MissingValue
                           ) -> Message:
        """
        Shortcut method for:
