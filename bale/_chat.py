...
class Chat(BaleObject):
    ...
    def __init__(self, chat_id: int, chat_type: str, title: Optional[str] = None,
                 ...
                 last_name: Optional[str] = None, photo: Optional["ChatPhoto"] = None,
                 invite_link: Optional[str] = None) -> None:
        super().__init__()
        self._id = chat_id
        self.id = chat_id
        self.type = chat_type
    ...
    async def send_document(self, document: Union["Document", FileInput], *, caption: MaybeMissing[str] = MissingValue,
                            components: MaybeMissing["InlineKeyboardMarkup", "MenuKeyboardMarkup"] = MissingValue,
                            delete_after: Optional[Union[float, int]] = None, file_name: MaybeMissing[str] = None):
        """
        Shortcut method for:
        ...
        """
        return await self.get_bot().send_document(self.id, document, caption=caption, components=components,
    ...
    async def send_photo(self, photo: Union["PhotoSize", FileInput], *, caption: MaybeMissing[str] = MissingValue,
        ...
        """
        return await self.get_bot().send_photo(self.id, photo, caption=caption, components=components,
                                               delete_after=delete_after, file_name=file_name)
    ...
    async def send_video(self, video: Union["Video", FileInput], *, caption: MaybeMissing[str] = MissingValue,
        ...
        """
        return await self.get_bot().send_video(self.id, video, caption=caption, components=components,
                                               delete_after=delete_after, file_name=file_name)
    ...
    async def send_animation(self, animation: Union["Animation", FileInput], *,
        ...
        """
        return await self.get_bot().send_animation(self.id, animation, duration=duration, width=width, height=height,
                                                   caption=caption, components=components,
                                                   delete_after=delete_after, file_name=file_name)

    async def send_audio(self, audio: Union["Audio", FileInput], *, caption: MaybeMissing[str] = MissingValue,
                         components: MaybeMissing["InlineKeyboardMarkup", "MenuKeyboardMarkup"] = MissingValue,
                         delete_after: Optional[Union[float, int]] = None, file_name: Optional[str] = None):
        """
        Shortcut method for:
        ...
        """
        return await self.get_bot().send_audio(self.id, audio, caption=caption, components=components,
                                               delete_after=delete_after, file_name=file_name)
    ...
    async def send_invoice(self, title: str, description: str, provider_token: str, prices: List["LabeledPrice"], *,
                           payload: MaybeMissing[str] = MissingValue, photo_url: MaybeMissing[str] = MissingValue,
                           need_name: MaybeMissing[bool] = MissingValue,
                           need_phone_number: MaybeMissing[bool] = MissingValue,
                           need_email: MaybeMissing[bool] = MissingValue,
                           need_shipping_address: MaybeMissing[bool] = MissingValue,
                           is_flexible: MaybeMissing[bool] = MissingValue,
                           delete_after: Optional[Union[float, int]] = None):
        """
        Shortcut method for:
    ...
    async def copy_message(self, chat_id: Union[int, str], message_id: Union[int, str],
                           reply_to_message_id: MaybeMissing[str, int] = MissingValue,
                           delete_after: Optional[Union[float, int]] = None):
        """
        Shortcut method for:
        ...
        """
        return await self.get_bot().copy_message(chat_id, self.id, message_id, reply_to_message_id=reply_to_message_id,
                                                 delete_after=delete_after)

    async def send_sticker(self, sticker: Union["Sticker", FileInput], *,
                           delete_after: Optional[Union[float, int]] = None):
        """
        Shortcut method for:
    ...
    async def unban_member(self, user: Union["User", str, int], *, only_if_banned: MaybeMissing[bool] = None):
        """
        Shortcut method for:
