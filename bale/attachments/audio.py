class Audio():
    ...
    def to_dict(self):
        ...
        data["duration"] = self.duration if self.duration is not None else None
        data["title"] = self.title if self.title is not None else None
        data["file_size"] = self.file_size if self.file_size is not None else None
        data["mime_type"] = self.mime_type if self.mime_type is not None else None
